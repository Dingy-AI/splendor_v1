...
def run_script():
    ...
    output_file = Path("splendor_v1/env/core/cost_lookup_table_v2.py")

    with open(output_file, "w") as f:
        f.write("# AUTO-GENERATED FILE. DO NOT EDIT.\n\n")
        f.write("from splendor_v1.env.core.enums import CardType\n\n")


        f.write("PAYMENT_TABLE = {\n")
        for card_type, payments in table.items():
            f.write(f"    CardType.{card_type.name}: {payments},\n")
