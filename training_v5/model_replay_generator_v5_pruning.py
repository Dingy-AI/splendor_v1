...
class ModelReplayGeneratorV5Pruning(
    ...
    # V5 PRUNING SEARCH METADATA

    # ============================================================



    def extract_pruning_search_metadata(
        ...
        Copy MCTS V5 adaptive-search diagnostics into replay-safe

        scalar fields. These fields are diagnostic only and do not

        alter the Model 4 policy/WDL training targets.
        ...
        if not isinstance(
            ...
            raise RuntimeError(
                ...
                "ModelReplayGeneratorV5Pruning expected "

                "MCTS V5 search metadata, but none was found. "

                "Use splendor_v1.mcts.mcts_v5_pruning.MCTS."
        ...
        field_map = {
            ...
            "min_simulations":
                ...
                "search_min_simulations",

            "check_interval":

                "search_check_interval",

            "target_visits_per_action":

                "search_target_visits_per_action",

            "single_action_simulations":

                "search_single_action_simulations",

            "stability_checks_required":

                "search_stability_checks_required",
            ...
            "target_total_root_visits":
                ...
                "search_target_total_root_visits",

            "soft_budget_simulations":

                "search_soft_budget_simulations",
            ...
            "best_action_stability_checks":

                "search_best_action_stability_checks",

            "root_noise_enabled":

                "search_root_noise_enabled",

            "best_action_key":

                "search_best_action_key",

            "best_action_visits":

                "search_best_action_visits",

            "second_action_visits":

                "search_second_action_visits",
            ...
            "top2_visit_share":
                ...
                "search_top2_visit_share",

            "top3_visit_share":

                "search_top3_visit_share",

            "visited_action_fraction":

                "search_visited_action_fraction",

            "normalized_visit_entropy":

                "search_normalized_visit_entropy",
            ...
            "visit_margin_ratio":
                ...
                "search_visit_margin_ratio",

            "winner_locked":

                "search_winner_locked",

            "best_action_q":

                "search_best_action_q",

            "second_action_q":

                "search_second_action_q",

            "q_gap":

                "search_q_gap",

            "network_prior_entropy":

                "search_network_prior_entropy",
        ...
        for source_field, replay_field in field_map.items():
        ...
        if missing:
            ...
            raise RuntimeError(
                ...
                "MCTS V5 search metadata is incomplete. "

                f"Missing replay fields: {missing}"
    ...
    def get_search_metadata(
        ...
        fields = [
            ...
            # MCTS V5 adaptive-search configuration.
        ...
        while not terminated:
            ...
            if step_index >= self.max_game_steps:
                ...
                raise RuntimeError(
                    ...
                    "ModelReplayGeneratorV5Pruning exceeded maximum "
            ...
            pruning_search_data = (
                ...
                self.extract_pruning_search_metadata(
...
#     from ...model_replay_generator_v5_pruning import ModelReplayGenerator
...
ModelReplayGenerator = ModelReplayGeneratorV5Pruning
