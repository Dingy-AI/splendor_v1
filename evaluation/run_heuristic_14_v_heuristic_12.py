...
from splendor_v1.agents.heuristic_agent_14 import HeuristicAgent14Diagnostics
...
def main_heuristic_vs_greedy():
    ...
    trained_agent = HeuristicAgent14Diagnostics(num_rollouts=16
    )
    ...
    print("\nEvaluating trained HeuristicAgent14Diagnostics vs HeuristicAgent12Diagnostics...")
    ...
    print(
        f"HeuristicAgent14Diagnostics wins: "
    ...
    print(
        f"HeuristicAgent14Diagnostics win rate: "
