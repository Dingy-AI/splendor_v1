...
def main_heuristic_vs_greedy():
    ...
    trained_agent = HeuristicAgent6(num_rollouts=8, name="HeuristicAgent6")

    greedy_agent = HeuristicAgent4(num_rollouts=8, name="HeuristicAgent4")

    # -------------------------
    # Evaluate
    # -------------------------

    print("\nEvaluating trained HeuristicAgent6 vs HeuristicAgent4...")
