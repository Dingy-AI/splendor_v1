...
from splendor_v1.agents.heuristic_agent_8 import HeuristicAgent8
...
def main_heuristic_vs_greedy():
    ...
    greedy_agent = HeuristicAgent8()

    # -------------------------
    # Evaluate
    # -------------------------

    print("\nEvaluating trained HeuristicAgent6 vs HeuristicAgent8...")
