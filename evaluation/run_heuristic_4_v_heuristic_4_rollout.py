...
def main_heuristic_vs_greedy():
    ...
    trained_agent = HeuristicAgent4(num_rollouts=28, name="rollout_28")

    greedy_agent = HeuristicAgent4(num_rollouts=32, name="rollout_32")

    # -------------------------
    # Evaluate
    # -------------------------

    print("\nEvaluating trained rollout_28 vs rollout_32...")
