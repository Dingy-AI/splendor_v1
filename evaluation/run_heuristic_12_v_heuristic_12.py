...
from splendor_v1.agents.heuristic_agent_12_noble_only import HeuristicAgent12NobleOnlyDiagnostics
...
def main_heuristic_vs_greedy():
    ...
    trained_agent = HeuristicAgent12NobleOnlyDiagnostics(num_rollouts=16
    )
    ...
    print("\nEvaluating trained HeuristicAgent12NobleOnlyDiagnostics vs HeuristicAgent12...")
    ...
    print(
        f"HeuristicAgent12NobleOnlyDiagnostics wins: "
        f"{results['agent_a_wins']}"
    )

    print(
        f"HeuristicAgent12 wins: "
    ...
    print(
        f"HeuristicAgent12NobleOnlyDiagnostics win rate: "
