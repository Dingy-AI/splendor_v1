...
class ModelReplayGenerator(
    ...
    def validate_search_data(
        ...
        # Every MCTS child must correspond to
        # an actually legal action.
        if policy_ids != legal_ids:
            ...
            raise RuntimeError(
                "MCTS root actions do not exactly match "
                "the legal actions for this state. "
