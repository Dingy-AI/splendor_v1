...
# ============================================================
# Model 2: Structured self-attention network
# ============================================================
#
# External interface stays the same as model 1:
#
#     input:
#         [batch, 258]
#
...
class SplendorNetwork(nn.Module):
    ...
    Outputs:
        policy: [batch, ACTION_SPACE_SIZE]
        value:  [batch, 1]
    """
    ...
    def __init__(
        ...
        if (
            ...
            raise ValueError(
                "model_2_attention.py currently expects "
        ...
        # Model 2 intentionally keeps the same flat policy interface
        # as Model 1. A structured action-conditioned policy is a
