...
from splendor_v1.mcts.mcts_v4 import (
    MCTS,
)
...
from splendor_v1.training_v4.model_replay_generator_v4 import (
...
def run_training(
    ...
    """
    Model 4 self-play + training loop.

    Each iteration:

        1. Freeze the current model for self-play.
        2. Generate self-play games with MCTS v4.
        ...
        while (
            ...
            try:
                ...
                if (
                    ...
                    raise RuntimeError(
                        "Model 4 self-play aborted after "
