...
from splendor_v1.training_v4.train_v4 import (
    run_training,
)
...
#     - Create a fresh empty V4 rich replay buffer.
...
# ------------------------------------------------------------
#
# Set this to the exact V4 self-play checkpoint you want to resume.
#
# Example:
#
#     checkpoints/gen_4/self_play/model_1000_games.pt
#
# or:
#
#     checkpoints/gen_4/self_play/model_1000_games_last.pt
#
# depending on your checkpoint naming.
# ------------------------------------------------------------

RESUME_CHECKPOINT_PATH = (
    "checkpoints/gen_4/self_play/"
    "model_1000_games_last.pt"
)
...
OUTPUT_REPLAY_PATH = (
    "splendor_v1/training_v4/data/"
    "replay_buffer_model4.pkl"
)
...
#     SIMULATIONS = 20
#
# Once that succeeds, restore the full settings below.
...
def create_fresh_replay_buffer():
    ...
    print(
        "Created fresh Model 4 replay buffer."
    )
...
print(
    "Stored V4 replay games:",
    count_v4_generated_games(
        replay_buffer
    ),
)
